using AspNetCoreMongoDbExample.Core;
...
namespace AspNetCoreMongoDbExample.Controllers
{
    ...
    {
        private readonly IShipwrecksService _shipwrecks;
        private readonly ILogger<HomeController> _logger;

        public HomeController(ILogger<HomeController> logger, IShipwrecksService shipwrecksService)
        {
            _logger = logger;
            _shipwrecks = shipwrecksService;
        }

        public async Task<IActionResult> Index()
        {
            var model = _shipwrecks.GetShipwrecks();
